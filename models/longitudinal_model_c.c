   ...
   )
{
    ...
    */
    ...
    double *g;
		...
		double *rho_diam_top_pwr_four, *rho_diam_pusher_pwr_four, *rho_diam_pusher_pwr_three,
    ...
    rho_diam_top_pwr_five = p[3];
		rho_diam_pusher_pwr_three = p[4];
		rho_diam_pusher_pwr_four = p[5];
		rho_diam_pusher_pwr_five = p[6];
    ...
    chord = p[8];
    wingspan = p[9];
		nondim_constant_lon = p[10];
		nondim_constant_lat = p[11];
    lam = p[12]; // Vector of 8 elements
		...
		double *c_T_0_pusher, *c_T_top, *c_Q_top;
		c_T_0_pusher = p[19];
		c_T_top = p[20];
		c_Q_top = p[21];
