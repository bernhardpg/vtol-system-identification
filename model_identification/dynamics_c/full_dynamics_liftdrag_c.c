   ...
   )
{
    ...
    */
		...
		double c_D_0, c_D_alpha, c_D_q, c_D_alpha_sq, c_D_delta_e, c_L_0, c_L_alpha, c_L_delta_e, c_m_0, c_m_alpha, c_m_q, c_m_delta_e, c_m_delta_e_sq, c_m_alpha_sq, c_Y_0, c_Y_beta, c_Y_p, c_Y_delta_a, c_Y_delta_r, c_l_0, c_l_delta_a, c_l_p, c_l_beta, c_l_r, c_n_0, c_n_beta, c_n_p, c_n_r, c_n_delta_a, c_n_delta_r;
    ...
    double c_Y = c_Y_0 + c_Y_p * p_hat + c_Y_beta * beta + c_Y_delta_a * delta_a + c_Y_delta_r * delta_r;
    double c_l = c_l_0 + c_l_p * p_hat + c_l_r * r_hat + c_l_beta * beta + c_l_delta_a * delta_a;
    double c_n = c_n_0 + c_n_beta * beta + c_n_p * p_hat + c_n_delta_a * delta_a + c_n_delta_r * delta_r;
