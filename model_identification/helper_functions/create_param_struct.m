...
function [ParName, ParFixed, ParMin, ParMax, ParValue] = create_common_model_params()
    ...
    ParFixed = {
        ...
        true,... % rho_diam_pusher_pwr_three, ...
    ...
    ParMin = {
        ...
        approx_zero,... % rho_diam_top_pwr_four, ...
        approx_zero,... % rho_diam_top_pwr_five, ...
        approx_zero,... % rho_diam_pusher_pwr_three, ...
        approx_zero,... % rho_diam_pusher_pwr_four, ...
        approx_zero,... % rho_diam_pusher_pwr_five, ...
        approx_zero,... % mass_kg,					...
