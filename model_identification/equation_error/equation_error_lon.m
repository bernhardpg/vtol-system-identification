...
% Basis regressors
regr = [aoa q_hat (delta_vl + delta_vr) / 2]; % Include delta_r as lon model is actually affect by this due to aircraft design
regr_names = ["alpha" "q" "delta_v_sum"];
...
regr_val = [aoa q_hat (delta_vl + delta_vr) / 2];
zs_val = [c_D c_L c_m];
