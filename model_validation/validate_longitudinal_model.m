...
model_coeffs = {equation_error_coeffs_lon output_error_lon_coeffs output_error_coeffs_lon_final_coeffs};
model_names = ["EquationError" "OutputError" "OutputErrorFinal"];
