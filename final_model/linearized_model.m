...
c_L = c_L_0 + c_L_alpha * alpha_pert + c_L_delta_e * delta_e_pert;
c_m = c_m_0 + c_m_alpha * alpha_pert + c_m_q_hat * q_hat + c_m_delta_e * delta_e_pert;
...
% Propeller force
T = rho * prop_diam_pusher^4 * c_T_pusher * delta_t^2;
